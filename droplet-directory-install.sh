...
apt update
apt-get -y install php7.2 php7.2-zip php7.2-curl php7.2-mysql php-pear php7.2-imap libapache2-mod-php7.2 php7.2-gd php-imagick php7.2-cli php7.2-common php7.2-mbstring php7.2-xml libdbi-perl libdbd-mysql-perl libssh2-1-dev php-ssh2 php7.2-soap imagemagick pdftk openssh-server
...
CMS_BLUEBUTTON_SANDBOX_CLIENT_ID=
CMS_BLUEBUTTON_SANDBOX_CLIENT_SECRET=
